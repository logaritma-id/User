...
<body class="bg-brand-bg text-slate-300 font-sans antialiased h-screen flex overflow-hidden selection:bg-brand-accent1/30 selection:text-white">
    ...
    <script type="module">
        ...
        let _userData = {};
        try { if(_userStr) _userData = JSON.parse(_userStr); } catch(e) {}
        const businessName = _userData.namaBisnis || '';
        const ownerName = _userData.namaPemilik || '';
        ...
        document.addEventListener('DOMContentLoaded', () => {
            if(businessName) {
                ...
                if(titleEl) titleEl.innerText += ' - ' + businessName;
